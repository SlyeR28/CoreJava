...
public class BankAccount {
    ...
    public void withdraw(int amount){
            ...
            if(lock.tryLock(1000  , TimeUnit.MILLISECONDS)){
             if(balance >= amount) {
                 try {
                     ...
                     Thread.sleep(3000);
                     balance -= amount;
                     System.out.println(Thread.currentThread().getName() + "transaction successful " + amount);
                 } catch (Exception e) {
        ...
        if(Thread.currentThread().isInterrupted()){
            System.out.println("hello my name is rishabh kumar");
        }
    }
}
